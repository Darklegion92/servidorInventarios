...
CREATE TABLE `articulos` (
  ...
  CONSTRAINT `fgk_grupos_articulos` FOREIGN KEY (`idgrupo`) REFERENCES `grupos` (`idgrupo`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_marcas_articulos` FOREIGN KEY (`idmarca`) REFERENCES `marcas` (`idmarca`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_subgrupos_articulos` FOREIGN KEY (`idsubgrupo`) REFERENCES `subgrupos` (`idsubgrupo`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_tarifasiva_articulos` FOREIGN KEY (`idtarifaiva`) REFERENCES `tarifasiva` (`idtarifaiva`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_usuarios_articulos` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`) ON DELETE RESTRICT ON UPDATE CASCADE
...
INSERT INTO `bodegas` VALUES (1,'BODEGA 1',1,1,1,1,'2020-10-30 21:31:44');
...
CREATE TABLE `clientes` (
  ...
  CONSTRAINT `fgk_listas_precios_clientes` FOREIGN KEY (`idlistaprecios`) REFERENCES `listasprecios` (`idlistaprecios`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_tipos_documento_clientes` FOREIGN KEY (`idtipo_documento`) REFERENCES `tipos_documento` (`idtipo_documento`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_usuarios_clientes` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `devoluciones_ventas` (
  ...
  KEY `fgk_bodegas_devoluciones_ventas_idx` (`idbodega`),
  CONSTRAINT `fgk_bodegas_devoluciones_ventas` FOREIGN KEY (`idbodega`) REFERENCES `bodegas` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_factura_venta_detalles_devolucione_ventas` FOREIGN KEY (`idfactura_venta_detalle`) REFERENCES `factura_venta_detalles` (`idfactura_venta_detalle`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `factura_compra_detalles` (
  ...
  CONSTRAINT `fgk_articulos_orden_factura_detalles` FOREIGN KEY (`codigoarticulo`) REFERENCES `articulos` (`codigo`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_facturas_compra_factura_compra_detalles` FOREIGN KEY (`idfactura_compra`) REFERENCES `facturas_compra` (`idfactura_compra`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_tarifasiva_factura_compra_detalles` FOREIGN KEY (`idtarifaiva`) REFERENCES `tarifasiva` (`idtarifaiva`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `factura_venta_detalles` (
  ...
  KEY `fgk_bodegas_factura_venta` (`idbodega`),
  CONSTRAINT `fgk_articulos_factura_venta_detalles` FOREIGN KEY (`codigoarticulo`) REFERENCES `articulos` (`codigo`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_bodegas_factura_venta` FOREIGN KEY (`idbodega`) REFERENCES `bodegas` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_facturas_venta_factura_venta_detalles` FOREIGN KEY (`idfactura_venta`) REFERENCES `facturas_venta` (`idfactura_venta`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_tarifasiva_factura_venta_detalles` FOREIGN KEY (`idtarifaiva`) REFERENCES `tarifasiva` (`idtarifaiva`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `facturas_compra` (
  ...
  CONSTRAINT `fgk_proveedores_facturas_compra` FOREIGN KEY (`idproveedor`) REFERENCES `proveedores` (`idproveedor`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_usuarios_facturas_compra` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `facturas_venta` (
  ...
  CONSTRAINT `fgk_clientes_facturas_venta` FOREIGN KEY (`idcliente`) REFERENCES `clientes` (`idcliente`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_numeracion_facturas_venta` FOREIGN KEY (`prefijo`) REFERENCES `numeracion` (`prefijo`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_usuarios_facturas_venta` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `grupos` (
  ...
  CONSTRAINT `fgk_usuarios_grupos` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `inventario` (
  ...
  KEY `fgk_bodegas_inventario` (`idbodega`),
  CONSTRAINT `fgk_articulos_inventario` FOREIGN KEY (`idarticulo`) REFERENCES `articulos` (`idarticulo`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE `listasprecios` (
  ...
  CONSTRAINT `fgk_usuarios_listasprecios` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `movimiento_articulos` (
  ...
  KEY `fgk_bodegas_movimiento_articulos` (`idbodega`),
  CONSTRAINT `fgk_articulos_movimiento_articulos` FOREIGN KEY (`idarticulo`) REFERENCES `articulos` (`idarticulo`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE `numeracion` (
  ...
  CONSTRAINT `fgk_usuarios_numeracion` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orden_compra_detalles` (
  ...
  CONSTRAINT `fgk_articulos_orden_compra_detalles` FOREIGN KEY (`codigoarticulo`) REFERENCES `articulos` (`codigo`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_ordenes_compra_orden_compra_detalles` FOREIGN KEY (`idorden_compra`) REFERENCES `ordenes_compra` (`idorden_compra`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_tarifasiva_orden_compra_detalles` FOREIGN KEY (`idtarifaiva`) REFERENCES `tarifasiva` (`idtarifaiva`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ordenes_compra` (
  ...
  CONSTRAINT `fgk_proveedores_ordenes_compra` FOREIGN KEY (`idproveedor`) REFERENCES `proveedores` (`idproveedor`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_usuarios_ordenes_compra` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `permisos` VALUES (1,'ACCESO MODULO','Acceso al modulo facturación','FACTURACION','2020-06-29'),(2,'FACTURAS REGISTRO','Acceso para registrar facturas de venta','FACTURACION','2020-06-29'),(3,'GESTION PARAMETROS','Acceso para gestionar parámetros de configuración de facturación','FACTURACION','2020-06-29'),(4,'INFORMES','Acceso para ingresar a los informes de facturación','FACTURACION','2020-06-29'),(5,'DEVOLUCIONES REGISTRO','Acceso para registrar devoluciones en facturas de venta','FACTURACION','2020-06-29');
...
CREATE TABLE `precios` (
  ...
  CONSTRAINT `fgk_articulos_precios` FOREIGN KEY (`idarticulo`) REFERENCES `articulos` (`idarticulo`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_listasprecios_precios` FOREIGN KEY (`idlistaprecios`) REFERENCES `listasprecios` (`idlistaprecios`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_usuarios_precios` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `proveedores` (
  ...
  CONSTRAINT `fgk_regimenes_proveedor` FOREIGN KEY (`idregimen`) REFERENCES `regimenes` (`idregimen`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_tipo_documento_proveedores` FOREIGN KEY (`idtipo_documento`) REFERENCES `tipos_documento` (`idtipo_documento`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_usuario_proveedores` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `regimenes` (
  ...
  CONSTRAINT `fgk_usuario_regimenes` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `roles` (
  ...
  UNIQUE KEY `nombre_UNIQUE` (`nombre`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='se encarga de guardar los roles de los usuarios';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `roles` VALUES (1,'ADMINISTRADOR','2020-06-29');
...
CREATE TABLE `roles_permisos` (
  ...
  CONSTRAINT `fgk_permisos_roles_permisos` FOREIGN KEY (`idpermiso`) REFERENCES `permisos` (`idpermiso`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
INSERT INTO `roles_permisos` VALUES (1,1,1,'2020-06-29 10:00:00'),(2,1,2,'2020-06-29 10:00:00'),(3,1,3,'2020-06-29 10:00:00'),(4,1,4,'2020-06-29 10:00:00'),(5,1,5,'2020-06-29 10:00:00');
...
CREATE TABLE `subgrupos` (
  ...
  CONSTRAINT `fgk_grupos_subgrupos` FOREIGN KEY (`idgrupo`) REFERENCES `grupos` (`idgrupo`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_usuarios_subgrupos` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sucursales` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `nombre` (`nombre`),
  KEY `fgk_usuarios_sucursales` (`idusuario`),
...
INSERT INTO `sucursales` VALUES (1,'SUCURSAL 1',1,1,'2020-10-30 21:29:15');
...
CREATE TABLE `tarifasiva` (
  ...
  CONSTRAINT `fgk_usuario_tarifasiva` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tipos_documento` (
  ...
  CONSTRAINT `fgk_usuarios_tipos_documento` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tipos_informe` VALUES (1,'VENTAS X ARTICULO','FACTURACION');
...
CREATE TABLE `usuarios` (
  ...
  CONSTRAINT `fgk_roles_usuarios` FOREIGN KEY (`idRol`) REFERENCES `roles` (`idrol`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fgk_sucurales_usuarios` FOREIGN KEY (`idsucursal`) REFERENCES `sucursales` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuarios` VALUES (1,'ADMIN','1234',1,'ADMINISTRADOR DEL SISTEMA','2020-06-29 00:00:00',1);
...
-- Dump completed on 2020-11-18 20:13:38
